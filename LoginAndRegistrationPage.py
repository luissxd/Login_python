from tkinter import *
from PIL import ImageTk, Image #INSTALAR PILLOW EN EL TERMINAL
...
window.title('Página de ingreso y registro')

# VENTANA_ICONO
icon = PhotoImage(file='images\\sise_icon.png')
...
email_label = Label(design_frame4, text='• Correo eletrónico', fg="#89898b", bg='#f8f8f8', font=("yu gothic ui", 11, 'bold'))
...
password_label = Label(design_frame4, text='• Contraseña', fg="#89898b", bg='#f8f8f8', font=("yu gothic ui", 11, 'bold'))
...
# ====== BOTON 
checkButton = Checkbutton(design_frame4, bg='#f8f8f8', command=password_command, text='Mostrar contraseña')
checkButton.place(x=140, y=288)

# ========= BOTONES 
SignUp_button = Button(LoginPage, text='Registro', font=("yu gothic ui bold", 12), bg='#f8f8f8', fg="#89898b",
...
# ===== BIENVENIDA 
welcome_label = Label(design_frame4, text='Bienvenido', font=('Arial', 20, 'bold'), bg='#f8f8f8')
welcome_label.place(x=130, y=15)

# ======= ARRIBA 
login_button = Button(LoginPage, text='Ingreso', font=("yu gothic ui bold", 12), bg='#f8f8f8', fg="#89898b",
...
# ==== ABAJO 
loginBtn1 = Button(design_frame4, fg='#f8f8f8', text='Ingreso', bg='#1b87d2', font=("yu gothic ui bold", 15),
...
def forgot_password():
    ...
    win.title('Olvidé la contraseña')
    ...
    email_label2 = Label(win, text='• Correo electrónico', fg="#89898b", bg='#f8f8f8',
    ...
    new_password_label = Label(win, text='• Nueva contraseña', fg="#89898b", bg='#f8f8f8', font=("yu gothic ui", 11, 'bold'))
    ...
    confirm_password_label = Label(win, text='• Confirma contraseña', fg="#89898b", bg='#f8f8f8',
    font=("yu gothic ui", 11, 'bold'))
    confirm_password_label.place(x=40, y=160)

    # ======= ACTUALIZAR CONTRASEÑA 
    update_pass = Button(win, fg='#f8f8f8', text='Actualizar contraseña', bg='#1b87d2', font=("yu gothic ui bold", 14),
    cursor='hand2', activebackground='#1b87d2')
    update_pass.place(x=40, y=240, width=256, height=50)


forgotPassword = Button(design_frame4, text='Olvidé contraseña', font=("yu gothic ui", 8, "bold underline"), bg='#f8f8f8',
...
name_label = Label(design_frame8, text='•Nombre completo', fg="#89898b", bg='#f8f8f8', font=("yu gothic ui", 11, 'bold'))
...
email_entry.config(highlightbackground="black", highlightcolor="black")
email_label = Label(design_frame8, text='•Correo Electrónico', fg="#89898b", bg='#f8f8f8', font=("yu gothic ui", 11, 'bold'))
...
password_label = Label(design_frame8, text='•Contraseña', fg="#89898b", bg='#f8f8f8',
font=("yu gothic ui", 11, 'bold'))
...
confirmPassword_label = Label(design_frame8, text='•Confirmar constraseña', fg="#89898b", bg='#f8f8f8',
font=("yu gothic ui", 11, 'bold'))
confirmPassword_label.place(x=280, y=355)

# ========= BOTONES 
SignUp_button = Button(RegistrationPage, text='Registro', font=("yu gothic ui bold", 12), bg='#f8f8f8', fg="#89898b",
...
# ===== BIENVENIDO 
welcome_label = Label(design_frame8, text='Bienvenido', font=('Arial', 20, 'bold'), bg='#f8f8f8')
welcome_label.place(x=130, y=15)

# ========= INGRESO 
login_button = Button(RegistrationPage, text='Ingreso', font=("yu gothic ui bold", 12), bg='#f8f8f8', fg="#89898b",
borderwidth=0, activebackground='#1b87d2', command=lambda: show_frame(LoginPage), cursor='hand2')
login_button.place(x=845, y=175)

# ==== REGISTRO 
signUp2 = Button(design_frame8, fg='#f8f8f8', text='Registro', bg='#1b87d2', font=("yu gothic ui bold", 15),
cursor='hand2', activebackground='#1b87d2')
